...
openvibe is an open-source AI coding agent for the terminal, built headless-first so it can be embedded directly in your own applications.

## Documentation

| Page | Description |
|------|-------------|
| [Installation](installation.md) | Install, requirements, optional extras |
...
| [Permissions](permissions.md) | Permission modes, rules, and storage |
| [Configuration](configuration.md) | `openvibe.json` schema and resolution order |
| [MCP](mcp.md) | Model Context Protocol server integration |
| [Custom Tools](custom-tools.md) | Writing and registering your own tools |
| [Providers](providers.md) | Multi-provider LLM support |
